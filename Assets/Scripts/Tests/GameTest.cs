...
public class GameTest
{
    ...
    public void GameThrowsWithoutMouse()
    {
        List<Player> players = new List<Player> {
            new Player(Player.Animal.MOUSE, Player.Color.BLUE, new Position(0, 0))
        };
    ...
    {
        List<Player> players = new List<Player> {
            new Player(Player.Animal.RABBIT, Player.Color.BLUE, new Position(0, 0))
        };
        Assert.That(() => new Game(players, new Board()),
                    Throws.Exception.TypeOf<System.Exception>());
    }
    ...
    public void GameConstructsWithBothMouseAndRabbit()
    {
        ...
        {
            new Player(Player.Animal.RABBIT, Player.Color.BLUE, new Position(0, 0)),
            new Player(Player.Animal.MOUSE, Player.Color.RED, new Position(0, 0))
        };
    ...
    public void TestPossibleRabbitMovements()
    {
        ...
        // to (2, 0)
        Player rabbit = new Player(Player.Animal.RABBIT, Player.Color.BLUE, new Position(0, 0));
        ...
        Player mouse = new Player(Player.Animal.MOUSE, Player.Color.GREEN, new Position(3, 3));
        List<Player> players = new List<Player> { rabbit, mouse };
        Game game = new Game(players, board);

        // Verify starting position
        Assert.AreEqual(rabbit.Pos, new Position(0, 0));
        ...
        Assert.AreEqual(rabbit.Pos, new Position(1, 0));
        game.NextPlayer();
        ...
        Assert.AreEqual(game.Move(Tile.Direction.EAST).Status, MoveDetails.MoveStatus.SUCCESS_NEW);
        Assert.AreEqual(rabbit.Pos, new Position(2, 0));
    }
    ...
    public void TestPossibleMouseMovements()
    {
        ...
        // to (2, 0)
        Player mouse = new Player(Player.Animal.MOUSE, Player.Color.GREEN, new Position(0, 0));
        board.SetWall(new Wall(Wall.Type.OPEN), 0, 0, Tile.Direction.EAST);
        board.SetWall(new Wall(Wall.Type.CLOSED), 0, 0, Tile.Direction.SOUTH);
        ...
        // Create dummy rabbit
        Player rabbit = new Player(Player.Animal.RABBIT, Player.Color.BLUE, new Position(3, 3));
        List<Player> players = new List<Player> { mouse, rabbit };
        Game game = new Game(players, board);

        // Verify starting position
        Assert.AreEqual(mouse.Pos, new Position(0, 0));
        ...
        Assert.AreEqual(game.Move(Tile.Direction.EAST).Status, MoveDetails.MoveStatus.SUCCESS_NEW);
        Assert.AreEqual(mouse.Pos, new Position(1, 0));
        game.NextPlayer();
        ...
        Assert.AreEqual(game.Move(Tile.Direction.EAST).Status, MoveDetails.MoveStatus.SUCCESS_NEW);
        Assert.AreEqual(mouse.Pos, new Position(2, 0));
    }
    ...
    public void TestMagicDoorMovements()
    {
        ...
        Player mouse = new Player(Player.Animal.MOUSE, Player.Color.RED, new Position(2, 0));
        ...
        Assert.AreEqual(new Position(0, 0), rabbit.Pos);
        Assert.AreEqual(new Position(2, 0), mouse.Pos);
        ...
        Assert.AreEqual(new Position(0, 0), mouse.Pos);
    }
}